...
export declare function TreeViewItemStack({ actions, children, disabled, expandable, expanderDisabled, loading, ...otherProps }: ITreeViewItemStackProps): JSX.Element;
