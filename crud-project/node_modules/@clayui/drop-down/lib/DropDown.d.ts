...
declare function ClayDropDown(props: IProps): JSX.Element & {
...
declare namespace ClayDropDown {
    ...
    var Group: ({ children, header, role }: {
    ...
    var ItemList: ({ children, className, role, ...otherProps }: React.HTMLAttributes<HTMLUListElement>) => JSX.Element;
    var Search: ({ className, formProps, spritemap, ...otherProps }: import("./Search").IProps) => JSX.Element;
