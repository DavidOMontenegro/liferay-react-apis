...
Liferay.Loader.define("crud-project@1.0.0/Documents", ['module', 'exports', 'require', 'crud-project$react', '@crud-project$clayui/form', '@crud-project$clayui/button', '@crud-project$clayui/table', './site'], function (module, exports, require) {
  ...
  var global = window;
  {
    ...
    function Documents() {
      return (/*#__PURE__*/_react["default"].createElement("div", {
        ...
        }, /*#__PURE__*/_react["default"].createElement("h1", null, "Documents and Media"), /*#__PURE__*/_react["default"].createElement("hr", null), /*#__PURE__*/_react["default"].createElement(Document, null))
      );
    }
    ...
    function Document() {
      ...
      function doPost() {
        ...
        Liferay.Util.fetch("/o/headless-delivery/v1.0/sites/".concat(site, "/documents"), {
          method: 'POST',
          body: formData
        });
      }
      ...
      function doPut() {
        var formData = new FormData();
        formData.append('file', document.getElementById("theFile").files[0]);
        Liferay.Util.fetch("/o/headless-delivery/v1.0/documents/".concat(docId), {
          method: 'PUT',
          body: formData
        });
      }
      ...
      var get = (0, _react.useCallback)(function () {
        Liferay.Util.fetch("/o/headless-delivery/v1.0/sites/".concat(site, "/documents/")).then(function (res) {
          return res.json();
        }).then(function (data) {
          return setDocs(data.items);
        });
      ...
      var deleteDoc = (0, _react.useCallback)(function () {
        Liferay.Util.fetch("/o/headless-delivery/v1.0/documents/".concat(docId), {
          method: 'DELETE'
        }).then(function () {
          return setDocId('');
      ...
      return (/*#__PURE__*/_react["default"].createElement("div", null, /*#__PURE__*/_react["default"].createElement("div", {
        ...
        }, "Show Documents")), /*#__PURE__*/_react["default"].createElement("div", {
          id: "docTable",
          style: {
            display: 'none'
          }
          ...
          headingCell: true
        }, "Document ID"), /*#__PURE__*/_react["default"].createElement(_table["default"].Cell, {
          headingCell: true
        }, "Document Title"))), /*#__PURE__*/_react["default"].createElement(_table["default"].Body, null, docs.map(function (doc) {
          return (/*#__PURE__*/_react["default"].createElement(_table["default"].Row, {
              key: doc.id
            }, /*#__PURE__*/_react["default"].createElement(_table["default"].Cell, {
              headingTitle: true
            }, doc.id), /*#__PURE__*/_react["default"].createElement(_table["default"].Cell, null, doc.title))
          );
        ...
        }, "Delete Document"), /*#__PURE__*/_react["default"].createElement("br", {
          style: {
            marginBottom: '4em'
          }
        ...
        }, "Post Document"), /*#__PURE__*/_react["default"].createElement(_button["default"], {
          displayType: "secondary",
          onClick: function onClick() {
            return doPut();
          }
