...
declare const _default: (({ center, children, className, containerElementRef, containerProps, disableAutoClose, observer, size, spritemap, status, zIndex, ...otherProps }: IProps) => JSX.Element) & {
