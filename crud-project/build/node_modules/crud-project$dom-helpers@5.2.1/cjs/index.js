...
Liferay.Loader.define("crud-project$dom-helpers@5.2.1/cjs/index", ['module', 'exports', 'require', '@crud-project$babel/runtime/helpers/interopRequireDefault', './activeElement', './addClass', './addEventListener', './animate', './animationFrame', './attribute', './childElements', './clear', './closest', './contains', './childNodes', './css', './filterEventHandler', './getComputedStyle', './hasClass', './height', './insertAfter', './isInput', './isVisible', './listen', './matches', './nextUntil', './offset', './offsetParent', './ownerDocument', './ownerWindow', './parents', './position', './prepend', './querySelectorAll', './remove', './removeClass', './removeEventListener', './scrollbarSize', './scrollLeft', './scrollParent', './scrollTo', './scrollTop', './siblings', './text', './toggleClass', './transitionEnd', './triggerEvent', './width'], function (module, exports, require) {
  var define = undefined;
  var global = window;
  {
    var _interopRequireDefault = require("@crud-project$babel/runtime/helpers/interopRequireDefault");
