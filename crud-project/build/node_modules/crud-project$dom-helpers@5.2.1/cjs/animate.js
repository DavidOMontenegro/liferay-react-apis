...
Liferay.Loader.define("crud-project$dom-helpers@5.2.1/cjs/animate", ['module', 'exports', 'require', '@crud-project$babel/runtime/helpers/interopRequireDefault', './css', './hyphenate', './isTransform', './transitionEnd'], function (module, exports, require) {
  ...
  var global = window;
  {
    ...
    function _animate(_ref) {
      ...
      var removeListener = (0, _transitionEnd.default)(node, function done(event) {
        if (event.target !== event.currentTarget) return;
        (0, _css.default)(node, reset);
        if (callback) callback.call(this, event);
      }, duration); // eslint-disable-next-line no-unused-expressions
