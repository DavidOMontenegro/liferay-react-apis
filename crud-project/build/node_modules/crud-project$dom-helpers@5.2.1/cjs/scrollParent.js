...
Liferay.Loader.define("crud-project$dom-helpers@5.2.1/cjs/scrollParent", ['module', 'exports', 'require', '@crud-project$babel/runtime/helpers/interopRequireDefault', './css', './height', './isDocument'], function (module, exports, require) {
  ...
  var global = window;
  {
    ...
    function scrollParent(element, firstPossible) {
      ...
      while ((element = element.parentNode) && !(0, _isDocument.default)(element)) {
        var isStatic = position === 'absolute' && (0, _css.default)(element, 'position') === 'static';
