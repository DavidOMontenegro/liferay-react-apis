Liferay.Loader.define('crud-project$react-dnd-html5-backend@11.1.3/dist/umd/ReactDnDHTML5Backend', ['module', 'exports', 'require'], function (module, exports, require) {
  var define = undefined;
  var global = window;
  {
    (function (global, factory) {
      typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports) : typeof define === 'function' && define.amd ? define(['exports'], factory) : (global = global || self, factory(global.ReactDnDHTML5Backend = {}));
      ...
      var EnterLeaveCounter = /*#__PURE__*/function () {
        ...
        _createClass(EnterLeaveCounter, [{
          ...
          value: function enter(enteringNode) {
            ...
            this.entered = union(this.entered.filter(function isNodeEntered(node) {
      ...
      function getDragPreviewOffset(sourceNode, dragPreview, clientOffset, anchorPoint, offsetPoint) {
        ...
        return {
          x: offsetX === 0 || offsetX ? offsetX : function calculateXOffset() {
          ...
          y: offsetY === 0 || offsetY ? offsetY : function calculateYOffset() {
      ...
      var HTML5BackendImpl = /*#__PURE__*/function () {
        function HTML5BackendImpl(manager, globalContext) {
          ...
          this.handleTopDragStart = function (e) {
            ...
            if (_this.monitor.isDragging()) {
              if (dataTransfer && typeof dataTransfer.setDragImage === 'function') {
                ...
                if (dragPreview) {
                  ...
                  var dragPreviewOffset = getDragPreviewOffset(sourceNode, dragPreview, clientOffset, {
                    anchorX: anchorX,
                    anchorY: anchorY
                  }, {
                    offsetX: offsetX,
            ...
            } else if (dataTransfer && !dataTransfer.types && (e.target && !e.target.hasAttribute || !e.target.hasAttribute('draggable'))) {} else {
      ...
      exports.HTML5Backend = function createBackend(manager, context) {
...
//# sourceMappingURL=ReactDnDHTML5Backend.js.map