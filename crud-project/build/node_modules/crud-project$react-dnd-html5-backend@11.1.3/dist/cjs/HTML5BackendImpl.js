...
Liferay.Loader.define("crud-project$react-dnd-html5-backend@11.1.3/dist/cjs/HTML5BackendImpl", ['module', 'exports', 'require', './EnterLeaveCounter', './BrowserDetector', './OffsetUtils', './NativeDragSources', './NativeTypes', './OptionsReader'], function (module, exports, require) {
          ...
          if (_this.monitor.isDragging()) {
            if (dataTransfer && typeof dataTransfer.setDragImage === 'function') {
              ...
              if (dragPreview) {
                ...
                var dragPreviewOffset = (0, _OffsetUtils.getDragPreviewOffset)(sourceNode, dragPreview, clientOffset, {
                  anchorX: anchorX,
                  anchorY: anchorY
                }, {
                  offsetX: offsetX,
