...
Liferay.Loader.define("@crud-project$clayui/drop-down@3.75.2/lib/DropDown", ['module', 'exports', 'require', '@crud-project$clayui/shared', 'crud-project$aria-hidden', 'crud-project$classnames', 'crud-project$react', './Action', './Caption', './Divider', './DropDownContext', './Group', './Help', './Item', './ItemList', './Menu', './Search', './Section'], function (module, exports, require) {
