...
export declare const ClayDropDownWithDrilldown: {
    ({ active, alignmentByViewport, alignmentPosition, className, containerElement, defaultActive, defaultActiveMenu, initialActiveMenu, menuElementAttrs, menuHeight, menuWidth, menus, offsetFn, onActiveChange, renderMenuOnClick, spritemap, trigger, }: IProps): JSX.Element;
    displayName: string;
};
