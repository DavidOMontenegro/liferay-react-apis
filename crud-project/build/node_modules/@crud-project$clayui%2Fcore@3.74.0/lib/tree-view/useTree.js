...
Liferay.Loader.define("@crud-project$clayui/core@3.74.0/lib/tree-view/useTree", ['module', 'exports', 'require', '@crud-project$clayui/shared', 'crud-project$react', './useMultipleSelection'], function (module, exports, require) {
  ...
  var global = window;
  {
    ...
    var _react = require("crud-project$react");
        ...
        defaultValue: function defaultValue() {
          ...
          if (selectionHydrationMode === 'hydrate-first' && items && selection.selectedKeys.size) {
            ...
            if (selectionMode === 'multiple-recursive') {
              selection.replaceIntermediateKeys(expand.filter(function (key) {
            ...
            case 'move':
              {
                ...
                var pathToAdd = nodeByPath(_path3);

                if (pathToAdd.parent) {
                  pathToAdd.parent[nestedKey] = [].concat(_toConsumableArray(pathToAdd.parent[nestedKey].slice(0, pathToAdd.index)), [nodeToRemove.item], _toConsumableArray(pathToAdd.parent[nestedKey].slice(pathToAdd.index)));
                } else {
                  immutableTree = [].concat(_toConsumableArray(immutableTree.slice(0, pathToAdd.index)), [nodeToRemove.item], _toConsumableArray(immutableTree.slice(pathToAdd.index)));
                }
