...
Liferay.Loader.define("@crud-project$clayui/core@3.74.0/lib/tree-view/TreeView", ['module', 'exports', 'require', '@crud-project$clayui/shared', 'crud-project$classnames', 'crud-project$react', 'crud-project$react-dnd', 'crud-project$react-dnd-html5-backend', './Collection', './DragLayer', './TreeViewGroup', './TreeViewItem', './context', './useTree'], function (module, exports, require) {
  ...
  var global = window;
  {
    ...
    var _reactDnd = require("crud-project$react-dnd");

    var _reactDndHtml5Backend = require("crud-project$react-dnd-html5-backend");
    ...
    var _excluded = ["children", "className", "defaultExpandedKeys", "defaultItems", "defaultSelectedKeys", "displayType", "dragAndDrop", "dragAndDropContext", "expandDoubleClick", "expandedKeys", "expanderClassName", "expanderIcons", "expandOnCheck", "items", "nestedKey", "onExpandedChange", "onItemMove", "onItemsChange", "onLoadMore", "onRenameItem", "onSelect", "onSelectionChange", "selectedKeys", "selectionHydrationMode", "selectionMode", "showExpanderOnHover"];
    ...
    function TreeView(_ref) {
      ...
      return (/*#__PURE__*/_react.default.createElement(_shared.FocusScope, null, /*#__PURE__*/_react.default.createElement("ul", _extends({}, otherProps, {
          ...
          items: state.items
        }, children), /*#__PURE__*/_react.default.createElement(_DragLayer.default, null)))))
      );
    }
