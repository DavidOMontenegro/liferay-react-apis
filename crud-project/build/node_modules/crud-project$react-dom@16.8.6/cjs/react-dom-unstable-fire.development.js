...
Liferay.Loader.define('crud-project$react-dom@16.8.6/cjs/react-dom-unstable-fire.development', ['module', 'exports', 'require', 'crud-project$react', 'crud-project$object-assign', 'crud-project$prop-types/checkPropTypes', 'crud-project$scheduler', 'crud-project$scheduler/tracing'], function (module, exports, require) {
  ...
  var global = window;
  {
    (function () {
      ...
      var React = require('crud-project$react');
      var _assign = require('crud-project$object-assign');
      var checkPropTypes = require('crud-project$prop-types/checkPropTypes');
      var scheduler = require('crud-project$scheduler');
      var tracing = require('crud-project$scheduler/tracing');
