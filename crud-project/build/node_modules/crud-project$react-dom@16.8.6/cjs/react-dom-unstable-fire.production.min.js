...
*/
'use strict';
Liferay.Loader.define("crud-project$react-dom@16.8.6/cjs/react-dom-unstable-fire.production.min", ['module', 'exports', 'require', 'crud-project$react', 'crud-project$object-assign', 'crud-project$scheduler'], function (module, exports, require) {
  var define = undefined;
  var global = window;
  {
    var aa = require("crud-project$react"),
        n = require("crud-project$object-assign"),
        r = require("crud-project$scheduler");function ba(a, b, c, d, e, f, g, h) {
      if (!a) {
