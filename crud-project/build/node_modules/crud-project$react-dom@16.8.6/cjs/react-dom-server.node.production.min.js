...
'use strict';
Liferay.Loader.define("crud-project$react-dom@16.8.6/cjs/react-dom-server.node.production.min", ['module', 'exports', 'require', 'crud-project$object-assign', 'crud-project$react', 'crud-project$stream'], function (module, exports, require) {
  var define = undefined;
  var global = window;
  {
    var p = require("crud-project$object-assign"),
        q = require("crud-project$react"),
        aa = require("crud-project$stream");function ba(a, b, d, c, f, e, h, g) {
      if (!a) {
