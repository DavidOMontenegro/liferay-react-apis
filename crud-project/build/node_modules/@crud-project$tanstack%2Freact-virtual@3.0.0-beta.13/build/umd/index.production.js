Liferay.Loader.define("@crud-project$tanstack/react-virtual@3.0.0-beta.13/build/umd/index.production", ['module', 'exports', 'require', 'crud-project$react'], function (module, exports, require) {
  ...
  var global = window;
  {
     ...
     */
    !function (e, t) {
      "object" == typeof exports && "undefined" != typeof module ? t(exports, require("crud-project$react")) : "function" == typeof define && define.amd ? define(["exports", "react"], t) : t((e = "undefined" != typeof globalThis ? globalThis : e || self).ReactVirtual = {}, e.React);
    }(this, function (e, t) {
      "use strict";
      var n,
          o = function s(e) {
        if (e && e.__esModule) return e;var t = Object.create(null);return e && Object.keys(e).forEach(function (s) {
          ...
          l = new Map(),
          r = function e() {
        var t = [];l.forEach(function (e, s) {
          var n,
              o,
              l = s.getBoundingClientRect();n = l, o = e.rect, void 0 === n && (n = {}), void 0 === o && (o = {}), i.some(function (e) {
            return n[e] !== o[e];
          }) && (e.rect = l, t.push(e));
      ...
      /**
        ...
        const s = u(e, t),
          ...
          return { observe: function () {
              var s = 0 === l.size;l.has(e) ? l.get(e).callbacks.push(t) : l.set(e, { rect: void 0, hasRectChanged: !1, callbacks: [t] }), s && r();
            }, unobserve: function () {
              var s = l.get(e);if (s) {
                var o = s.callbacks.indexOf(t);o >= 0 && s.callbacks.splice(o, 1), s.callbacks.length || l.delete(e), l.size || cancelAnimationFrame(n);
              }
            } };
        }(e.scrollElement, e => {
          s(e);
        });if (e.scrollElement) return s(e.scrollElement.getBoundingClientRect()), o.observe(), () => {
          o.unobserve();
        };
      },
            f = (e, t) => {
        const s = u(e, t),
          ...
          e.scrollElement.removeEventListener("resize", n);
            ...
            g = e => (t, s) => {
        if (!t.scrollElement) return;const n = m[e][0],
              o = m[e][1];let i = t.scrollElement[n],
            l = t.scrollElement[o];const r = () => {
          s(t.scrollElement[t.options.horizontal ? n : o]);
        };r();const a = e => {
          const s = e.currentTarget,
                a = s[n],
                c = s[o];(t.options.horizontal ? i - a : l - c) && r(), i = a, l = c;
        ...
        constructor(e) {
          var t = this;this.unsubs = [], this.scrollElement = null, this.measurementsCache = [], this.itemMeasurementsCache = {}, this.pendingMeasuredCacheIndexes = [], this.measureElementCache = {}, this.setOptions = e => {
            ...
            }), this.options = _extends({ debug: !1, initialOffset: 0, overscan: 1, paddingStart: 0, paddingEnd: 0, scrollPaddingStart: 0, scrollPaddingEnd: 0, horizontal: !1, getItemKey: c, rangeExtractor: h, enableSmoothScroll: !0, onChange: () => {}, measureElement: v, initialRect: { width: 0, height: 0 } }, e);
          }, this.notify = () => {
          ...
          }, this.getSize = () => this.scrollRect[this.options.horizontal ? "width" : "height"], this.getMeasurements = a(() => [this.options.count, this.options.paddingStart, this.options.getItemKey, this.itemMeasurementsCache], (e, t, s, n) => {
          ...
          }, { key: !1, debug: () => this.options.debug }), this.calculateRange = a(() => [this.getMeasurements(), this.getSize(), this.scrollOffset], (e, t, s) => function (e) {
          ...
          }({ measurements: e, outerSize: t, scrollOffset: s }), { key: !1, debug: () => this.options.debug }), this.getIndexes = a(() => [this.options.rangeExtractor, this.calculateRange(), this.options.overscan, this.options.count], (e, t, s, n) => e(_extends({}, t, { overscan: s, count: n })), { key: !1 }), this.getVirtualItems = a(() => [this.getIndexes(), this.getMeasurements(), this.options.measureElement], (e, t, s) => {
            const n = e => t => {
            ...
            let _ref = void 0 === s ? { align: "auto" } : s,
                ...
                o = _objectWithoutProperties(_ref, ["align"]);const i = t.getMeasurements(),
                  ...
                  r = t.getSize(),
                  { count: a } = t.options,
                  c = i[Math.max(0, Math.min(e, a - 1))];if (!c) return;if ("auto" === n) if (c.end >= l + r - t.options.scrollPaddingEnd) n = "end";else {
              if (!(c.start <= l + t.options.scrollPaddingStart)) return;n = "start";
            }const h = "end" === n ? c.end + t.options.scrollPaddingEnd : c.start - t.options.scrollPaddingStart;t.scrollToOffset(h, _extends({ align: n }, o));
          }, this.getTotalSize = () => {
      ...
      }const C = "undefined" != typeof window ? o.useLayoutEffect : o.useEffect;function y(e) {
        const t = o.useReducer(() => ({}), {})[1],
              s = _extends({}, e, { onChange: s => {
            t(), null == e.onChange || e.onChange(s);
          } }),
              [n] = o.useState(() => new w(s));return n.setOptions(s), o.useEffect(() => n._didMount(), []), C(() => n._willUpdate()), n;
      }e.Virtualizer = w, e.defaultKeyExtractor = c, e.defaultRangeExtractor = h, e.elementScroll = O, e.measureElement = v, e.memo = a, e.observeElementOffset = p, e.observeElementRect = d, e.observeWindowOffset = E, e.observeWindowRect = f, e.useVirtualizer = function (e) {
        return y(_extends({ observeElementRect: d, observeElementOffset: p, scrollToFn: O }, e));
      }, e.useWindowVirtualizer = function (e) {
        return y(_extends({ getScrollElement: () => "undefined" != typeof window ? window : null, observeElementRect: f, observeElementOffset: E, scrollToFn: b }, e));
      }, e.windowScroll = b, Object.defineProperty(e, "__esModule", { value: !0 });
    });
