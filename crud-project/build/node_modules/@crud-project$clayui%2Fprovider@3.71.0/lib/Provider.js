...
Liferay.Loader.define("@crud-project$clayui/provider@3.71.0/lib/Provider", ['module', 'exports', 'require', '@crud-project$clayui/icon', 'crud-project$react', './DataClient'], function (module, exports, require) {
  ...
  var global = window;
  {
    ...
    var _icon = require("@crud-project$clayui/icon");
