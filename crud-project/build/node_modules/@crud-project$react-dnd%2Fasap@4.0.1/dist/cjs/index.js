...
Liferay.Loader.define("@crud-project$react-dnd/asap@4.0.1/dist/cjs/index", ['module', 'exports', 'require', './asap', './types', './AsapQueue', './TaskFactory'], function (module, exports, require) {
    ...
    var global = window;
    {
        ...
        var _exportNames = {};
        var _asapJs = _interopRequireWildcard(require("./asap"));
        ...
        var _typesJs = _interopRequireWildcard(require("./types"));
        ...
        var _asapQueueJs = _interopRequireWildcard(require("./AsapQueue"));
        ...
        var _taskFactoryJs = _interopRequireWildcard(require("./TaskFactory"));
