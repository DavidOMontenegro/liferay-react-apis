...
Liferay.Loader.define("@crud-project$clayui/drop-down@3.74.0/lib/Item", ['module', 'exports', 'require', '@crud-project$clayui/icon', '@crud-project$clayui/link', 'crud-project$classnames', 'crud-project$react', './DropDownContext'], function (module, exports, require) {
  ...
  var global = window;
  {
    ...
    var _link = _interopRequireDefault(require("@crud-project$clayui/link"));
    ...
    var _excluded = ["active", "children", "className", "disabled", "href", "innerRef", "onClick", "role", "roleItem", "spritemap", "symbolLeft", "symbolRight", "tabIndex"];
