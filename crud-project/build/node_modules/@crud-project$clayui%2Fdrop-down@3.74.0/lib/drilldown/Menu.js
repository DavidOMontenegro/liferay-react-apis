...
Liferay.Loader.define("@crud-project$clayui/drop-down@3.74.0/lib/drilldown/Menu", ['module', 'exports', 'require', '@crud-project$clayui/button', '@crud-project$clayui/icon', '@crud-project$clayui/shared', 'crud-project$classnames', 'crud-project$react', 'crud-project$react-transition-group', '../Divider'], function (module, exports, require) {
  ...
  var global = window;
  {
    ...
    var _button = require("@crud-project$clayui/button");
